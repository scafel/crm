                    ...
                    <tr>
                        ...
                        <td>
                            <div class="button-group">
                                ...
                                <a class="button border-blue" href="javascript:void(0);" onclick="outHispitle('{{ url('home/page/custom/leaveh') }}/{{ $value->custom_id }}/{{ idMd5Token($value->custom_id) }}')"><span class="icon-sign-out"></span> 出院</a>
                            </div>
                        </td>
                    </tr>
                @endforeach
        ...
        $.ajax({
            ...
            success:function (res) {
                ...
                if (res.errorcode == 1){
                    ...
                    window.location.href = "{{ url('home/page/custom/search/') }}/1"+"/"+res.data.url
                }else{
                    layer.alert("请求出错");
                }
            },
