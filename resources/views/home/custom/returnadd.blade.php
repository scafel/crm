...
<div class="panel admin-panel">
    ...
    <div class="body-content">
        <form id="form" action="{{ url('home/page/custom/returnadd') }}" method="post" class="form-x">
            <input id="token" class="token" type="hidden" name="_token" value="{{ csrf_token() }}">
            ...
            <div class="userMessage" style="display: none;">
                ...
                <div class="form-group addtime" style="display: none;">
                    ...
                    <div class="field">
                        <input id="test165" type="text" class="input w50" value="" name="intime" autocomplete="off"/>
                        <div class="tips"></div>
                    </div>
                </div>
                <div class="form-group addtime" style="display: none;">
                    ...
                    <div class="field">
                        <input id="test167" type="text" class="input w50" value="" name="outtime" autocomplete="off"/>
                        <div class="tips"></div>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field" style="padding-top:8px;">
                    @foreach($class as $value)
                        {{ $value->name }} &nbsp;<input type="radio" class="token" name="class_id" value="{{ $value->id }}" />
                    @endforeach
