                    ...
                    <tr>
                        ...
                        <td>
                            <div class="button-group">
                                ...
                                <a class="button border-red" href="javascript:void(0);" onclick="del('{{ url('home/page/user/del') }}/{{ $value->id }}/{{ idMd5Token($value->id) }}')"><span class="icon-trash-o"></span> 删除</a>
                            </div>
                        </td>
                    </tr>
                @endforeach
        ...
        $.ajax({
            ...
            success:function (res) {
                ...
                if (res.errorcode == 1){
                    ...
                    window.location.href = "{{ url('home/page/user/search/') }}"+"/"+res.data.url
                }else{
                    layer.alert("请求出错");
                }
            },
